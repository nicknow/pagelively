...
| T4  | **Paste HTML/Markdown** — publish API accepts pasted text (create-only first) instead of a file; Markdown goes through the same render pipeline (`source.md` + `index.html`).                                                                                               | in-progress | New API surface; the UI overhaul (T3) will style it in one pass.                                                                             | OQ-17        |
