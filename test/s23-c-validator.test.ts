...
// NOTE: AC9 tests (serveAsset rev/path/encoding matrix) have been removed
// from this file — they exercised asset-serve.ts logic (rev-parsing, path
// traversal, percent-encoding), which is outside the file's password-protection
// auth charter. Those cases are covered by asset-serve.test.ts.
