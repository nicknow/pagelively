...
**v1.4.0 released.** Raw Markdown hosting, tags and listing pages, per-page password
protection, multi-domain deployment support, a rich Markdown template system with automatic
dark mode, and the full CI/CD branching workflow. All features are implemented and covered by the automated test suite
